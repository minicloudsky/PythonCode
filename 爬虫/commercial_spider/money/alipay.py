...
class Douban():
    ...
    def login(self):
        ...
        try:
            ...
            pass
        self.browser.find_element_by_class_name('bn-submit').click()
    ...
    def send_per_group(self,url):
        ...
        try:
            ...
            #     sleep(3)
            self.browser.find_element_by_xpath('//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys("D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\ad.png")
            sleep(3)
            self.browser.find_element_by_xpath('//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys("D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\1.png")
            sleep(3)
            self.browser.find_element_by_xpath('//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys("D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\2.png")
            sleep(3)
            self.browser.find_element_by_xpath('//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys( "D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\3.png")
            sleep(3)
            self.browser.find_element_by_xpath(
                '//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys(
                "D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\4.png")
            sleep(3)
...
if __name__ == '__main__':
    keyword = ["python","大数据","深度学习","机器学习","人工智能","爬虫","python爬虫","java",
    "c语言","c++","php","nodejs","spark","hadoop","数据分析","程序员","编程"]
    title = "Python3 爬虫实战和大数据机器学习视频，需要的加qq:1397991131"
