...
class Douban():
    ...
    def send_per_group(self,url):
        ...
        try:
            ...
            #     sleep(3)
            self.browser.find_element_by_xpath('//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys("D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\votebar3.png")
            sleep(3)
            self.browser.find_element_by_xpath('//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys("D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\votebar.jpg")
            sleep(3)
            self.browser.find_element_by_xpath('//*[@id="group-editor-root"]/div/div[2]/div[2]/div/div[1]/span[1]/span/input').send_keys("D:\\pycharm\\PythonCode\\commercial_spider\\douban_send_text\\votebar2.png")
            sleep(3)
...
if __name__ == '__main__':
    keyword = ["微信群","兼职","兼职赚钱","宝妈","宝妈赚钱","大学生兼职"]
