...
parser.add_argument("url", help="Target Url, 你所需要文档的 URL",type=str)
...
###TIPS:PDF|PPT 只能下载图片
        ...
        print(" 获取出错，可能 URL 错误 \n 使用格式 name.exe url type\n 请使用 --help 查看帮助 ")