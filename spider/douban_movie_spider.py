...
class DoubanMovie:
    def __init__(self, movie_id, movie_page, comments_path):
        ...
        self.movie_time = 0
        self.better_than = ""
        self.response = requests.get(self.movie_index,headers = header)
        print(" HTTP状态码"+str(self.response.status_code))
        print(self.response.encoding)
        print(self.response.apparent_encoding)
    ...
    def get_short_comment_person_num(self):
        ...
        if len(content) !=0:
            ...
            self.all_comments.append("短评人数:" + str(self.short_comment_person_num) + "\n")
        print("短评数:" + str(self.short_comment_person_num))
    def get_movie_type(self):
        ...
        if(len(content)!=0):
            ...
            self.all_comments.append( "电影类型:" + str(self.movie_type) + "\n")
    ...
    def get_play_time(self):
        ...
        self.all_comments.append( "开播时间:" + str(self.play_time) + "\n")
        print("开播时间:" + str(self.play_time))
    ...
    def get_evaluate_person(self):
        ...
        self.all_comments.append("豆瓣影评人数:" + str(self.evaluate_person) + "\n")
        print("影评人数:" + str(self.evaluate_person))
    ...
    def get_watched_num(self):
        ...
        self.all_comments.append(str(self.watched)+"\n")
    ...
    def get_want_watch(self):
        ...
        self.all_comments.append(str(self.want_watch)+"\n")
    ...
    def get_movie_degree(self):
        ...
        self.all_comments.append("豆瓣评分:"+str(self.movie_degree)+"\n")
        ...
        for i in x:
            ...
            count = count-1
            print(str(str(count+1)+"星评价("+list[count-1]+"):" + str(counts)))
    ...
    def write_comments(self):
        print("一共有:"+str(len(self.all_comments))+"条评论")
        try:
            for con in self.all_comments:
                file = codecs.open(self.path + "douban_comments.txt", 'a+', 'utf-8')
                file.write(con)
                file.write("\r\n")
        except:
            print("写入评论失败")
