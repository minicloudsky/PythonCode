...
class pexels():
    ...
    def get_js(self):
        ...
        for i in range(1,self.page_num+1):
            list.append("https://www.pexels.com/search/"+str(self.keyword)+"/?page="+str(i)+"&seed=2018-07-12+22%3A19%3A08++0000&format=js&seed=2017-09-08%2022:19:08%20+0000")
        return list
    #获取每一页js中的图片链接
...
if __name__ == '__main__':
    ...
    down_keyword = []
    key = input("请输入要下载图片类型:")
    down_keyword.append(key)
    for i in down_keyword:
